...
export function HUD({ state }: HUDProps) {
  ...
  return (
    <G>
      ...
      {/* ステージ */}
      <SvgText x={10} y={70} fill="#FFFFFF" fontSize={12} fontWeight="bold" fontFamily="Courier">
        {`STAGE ${state.stage}`}
      </SvgText>

      {/* スコア */}
      <SvgText x={CONFIG.CANVAS_WIDTH - 10} y={30} fill="#FFFFFF" fontSize={12} fontWeight="bold" fontFamily="Courier" textAnchor="end">
        {`${state.score}`}
      </SvgText>
      ...
      {/* タイム */}
      <SvgText x={CONFIG.CANVAS_WIDTH - 10} y={55} fill="#FFFFFF" fontSize={12} fontWeight="bold" fontFamily="Courier" textAnchor="end">
        {timeText}
      </SvgText>
